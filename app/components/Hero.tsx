        ...
        <div className='bg-background py-10'>
            <div className='w-[89%] m-auto grid lg:grid-cols-2 grid-cols-1 items-center max-w-[1400px] gap-20'>
                <div>
                    ...
                    <p>With every purchase of our moonlamp 10% of the sale will go to donation. We love to give back to the community</p>
                ...
                <div className='flex lg:justify-end justify-center items-center'>
                    <Image src={heroImage} height={600} alt='hero' width={600} />
                </div>
            </div>
        </div>
    )
