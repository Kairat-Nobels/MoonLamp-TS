        ...
        <section className="py-20">
            <div className="w-[89%] m-auto max-w-[1400px] grid grid-cols-1 md:grid-cols-2 items-center gap-5">
                ...
                <div className="text-center">
                    ...
                    <p className="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Natus deleniti quos maxime, consectetur et eligendi, autem, quibusdam cum quisquam deserunt excepturi aspernatur nemo beatae corrupti enim praesentium asperiores obcaecati magnam aliquid odit ab omnis debitis. Explicabo.</p>
                </div>
            </div>
        </section>
    )
